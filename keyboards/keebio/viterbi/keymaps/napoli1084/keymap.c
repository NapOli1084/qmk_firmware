...
//#define NAPOLI1084_KEYMAPS_DISABLE

#include "napoli1084_keymap.h"

#ifdef NAPOLI1084_KEYMAPS_DISABLE
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LYR_QWERTY] = LAYOUT_ortho_5x14(
    ...
    TODEFLT, KC_LCTL, KC_NUBS, KC_LGUI, KC_LALT,OSL_QNAV, KC_SPC ,     KC_SPC , OSFN   , KC_RALT, KC_RGUI, KC_APP , KC_RCTL, KC_DEL
  ),
  ...
  [LYR_GAME] = LAYOUT_ortho_5x14(
    _______, GMLPOR5, GMLPKR5, GMLRGR4, GMLMDR4, GMLIDR4, GMLIOR4,     GMRIOR4, GMRIDR4, GMRMDR4, GMRRGR4, GMRPKR5, GMRPOR5, _______,
    _______, GMLPOR4, GMLPKR4, GMLRGR3, GMLMDR3, GMLIDR3, GMLIOR3,     GMRIOR3, GMRIDR3, GMRMDR3, GMRRGR3, GMRPKR4, GMRPOR4, _______,
    _______, GMLPOR3, GMLPKR3, GMLRGR2, GMLMDR2, GMLIDR2, GMLIOR2,     GMRIOR2, GMRIDR2, GMRMDR2, GMRRGR2, GMRPKR3, GMRPOR3, _______,
    _______, GMLPOR2, GMLPKR2, GMLRGR1, GMLMDR1, GMLIDR1, GMLIOR1,     GMRIOR1, GMRIDR1, GMRMDR1, GMRRGR1, GMRPKR2, GMRPOR2, _______,
